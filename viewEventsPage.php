...
if(mysqli_num_rows($result) > 0){
	...
	echo "<div class='detailsInfo'>".
         "<p class='paragraph'>Activity Name: <br>" .$row["name"]. 
	         "<br><br>Date: <br>".date("l d F Y h:i a",strtotime($row["date"])). 
	         "<br><br>Spaces Available: <br>" .$row["noOfSpaces"].
			 "<br><br>Event Image: <br>".
			 "<a href='editImagePage.php?ID=" .$row["ID"]. "'>".
			 "<button type='button'> Change Image </button><br>".
			 "</a>".
			 "<br><img class='adminImage' src='img/".$row['eventImage']."' target='_blank'>".
			 "<a href='removeEvent.php?name=" .$row["name"]. "'>".
			 "<br><br><button id='adminButton' type='button'>Remove Event</button>".
			 "</a>".
			 "<a href='editEventPage.php?ID=" .$row["ID"]. "'>".
			 "<button id='adminButton' type='button'>Edit Event</button>".
			 "<br>".
			 "</a>".
			 "</p>".
	         "</div><br><br>";
	...
	echo "<p> No events have been found in the events database! </p>";
}
