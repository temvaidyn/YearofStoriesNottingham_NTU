...
<p class="paragraph"><?php echo 'This event will take place on the '. date("l d F Y h:i a",strtotime($row["date"])); ?> </p> <!--http://www.dynamicdrive.com/forums/showthread.php?69138-How-to-get-date_format()-to-work-properly* used to format date/-->
