...
<h1 class="title"><?php echo 'Thank you for booking '. $name; ?></h1>

<p class="bookingSuccess"><?php echo 'Just a reminder, this event will take place on the '. $row["date"] ?> </p>
<p class="bookingSuccess">If you require any changes to be made to your booking please contact us as soon as possible. We hope you enjoy playing a part in Read on Nottingham this year!</p>
