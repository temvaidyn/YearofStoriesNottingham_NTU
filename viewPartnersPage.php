...
<h1 class="title">View Partners</h1>
...
if(mysqli_num_rows($result) > 0){
	...
	echo "<div class='detailsInfo'>".
         "<p class='paragraph'>Partner Name: <br>" .$row["name"]. 
			 "<br><br>Partner Logo: <br>".
			 "<a href='editPartnerLogoPage.php?ID=" .$row["ID"]. "'>".
			 "<button type='button'> Change Image </button><br>".
			 "</a>".
			 "<br><img class='adminImage' src='img/".$row['image']."' target='_blank'>".
			 "<a href='removePartner.php?name=" .$row["name"]. "'>".
			 "<br><br><button id='adminButton' type='button'>Remove</button>".
			 "</a>".
			 "<a href='editPartnersPage.php?ID=" .$row["ID"]. "'>".
			 "<button id='adminButton' type='button'>Edit Partner</button>".
			 "<br>".
			 "</a>".
			 "</p>".
	         "</div><br><br>";
	...
	echo "<p> No partners have been found in the partners database! </p>";
}
