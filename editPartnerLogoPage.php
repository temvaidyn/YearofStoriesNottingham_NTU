...
?>
<h1 class="title">Edit Partner Logo For <?php echo $row["name"] ?></h1>

<?php echo "<form id='adminLogin' onsubmit='return signUpValidation()' action='editPartnerLogo.php?ID=" .$row["ID"]. "' method='post'>" ?>
Partner ID (Read Only): <br>
<input class="adminText" type="text" name="partnerID" value="<?php echo $row["ID"]; ?>" readonly>
<br><br>
Partner Logo: <br>
...
<script language="javaScript">
	...
	function signUpValidation(x) { //form that validates the inputs in the form
		...
		if (xpartnerLogo == null || xpartnerImage == "") {  
